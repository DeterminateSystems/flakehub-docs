...
> TODO: make a nice component indicating that this is a beta feature

Webhooks can let your integrations take action in response to releases published on FlakeHub.
They can be associated with any public flake, or unlisted and private flakes your account has access to.
