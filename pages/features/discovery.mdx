...
<UrlFormat root="https://flakehub.com/label" segments={[
  "slash",
  { variable: true, name: "org" },
  "slash",
  { variable: true, name: "project" },
  "slash",
  { variable: true, name: "version-requirement" }
]} />

You can also use the [`fh`][cli]'s [`list versions`][cli-versions] command:
