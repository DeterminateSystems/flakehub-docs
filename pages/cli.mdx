...
<Admonition kind="success">
We also provide installation instructions [for NixOS][nixos-install].
</Admonition>
...
[nixos-install]: https://flakehub.com/flake/DeterminateSystems/fh#readme-installation
